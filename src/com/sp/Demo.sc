...
object Demo {
  ...
  def getFromFile(path: String) = {
  	...
  	g
  }                                               //> getFromFile: (path: String)com.sp.EdgeWeightedDiGraph
  
  val g = EdgeWeightedDiGraph(4, 3)               //> g  : com.sp.EdgeWeightedDiGraph = Array(-1, -1, -1, -1)
                                                  //| Array(-1, -1, -1, -1)
                                                  //| Array(-1, -1, -1, -1)
                                                  //| Array(-1, -1, -1, -1)
  ...
  g.edges                                         //> res0: scala.collection.immutable.IndexedSeq[com.sp.DirectedEdge] = Vector(0 
                                                  //| --10--> 1, 1 --10--> 2, 2 --10--> 3)
  g.V                                             //> res1: Int = 4
  
  g.adj(0)                                        //> res2: scala.collection.immutable.IndexedSeq[com.sp.DirectedEdge] = Vector(0 
                                                  //| --10--> 1)
  ...
  println (g toString)                            //> Array(-1, 10, -1, -1)
                                                  ...
                                                  //| Array(-1, -1, -1, 10)
                                                  //| Array(-1, -1, -1, -1)
  val dfs = DFS(g)                                //> dfs  : com.sp.DFS = DFS(Array(-1, 10, -1, -1)
                                                  //| Array(-1, -1, 10, -1)
                                                  //| Array(-1, -1, -1, 10)
                                                  //| Array(-1, -1, -1, -1))
  dfs.dfs(2)
  ...
  g.adj(0)                                        //> res4: scala.collection.immutable.IndexedSeq[com.sp.DirectedEdge] = Vector(0 
                                                  //| --10--> 1)
  
  val sp = SP(g, 0)                               //> sp  : com.sp.SP = SP(Array(-1, 10, -1, -1)
                                                  //| Array(-1, -1, 10, -1)
                                                  //| Array(-1, -1, -1, 10)
                                                  //| Array(-1, -1, -1, -1),0)
